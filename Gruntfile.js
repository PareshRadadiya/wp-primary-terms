module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            dist: {
                files: { 'assets/js/wp-primary-category.min.js': 'assets/js/wp-primary-category.js' },
        ...
        sass: {
            dist: {
                ...
                files: { 'assets/css/wp-primary-category.css': 'assets/css/sass/styles.scss' }
            }
        },
        cssmin: { dist: { files: { 'assets/css/wp-primary-category.min.css': 'assets/css/wp-primary-category.css' } } },
        usebanner: {
            taskName: {
                options: {
                    position: 'top',
                ...
                files: { src: ['assets/css/wp-primary-category.min.css'] }
            }
        }
    });
